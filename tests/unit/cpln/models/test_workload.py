...
class TestWorkload(unittest.TestCase):
    ...
    def test_clone_basic(self) -> None:
        ...
        args, kwargs = cast(Tuple[Tuple[Any, ...], Dict[str, Any]], self.client.api.create_workload.call_args)
    ...
    def test_clone_with_type_change(self) -> None:
        ...
        # Verify API call
        _, kwargs = cast(Tuple[Tuple[Any, ...], Dict[str, Any]], self.client.api.create_workload.call_args)
...
class TestWorkloadCollection(unittest.TestCase):
    ...
    def test_get_workload(self) -> None:
        ...
        # Setup test data
        config: WorkloadConfig = WorkloadConfig(gvc='test-gvc', workload_id='test-workload')
        workload_data: Dict[str, Any] = {'name': 'test-workload', 'spec': {'type': 'standard'}}
