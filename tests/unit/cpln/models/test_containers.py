...
class TestContainerCollection(unittest.TestCase):
    ...
    def test_list_containers_requires_workload_name(self) -> None:
        """Test that list method requires workload_name parameter"""
        # This should work with workload_name
        try:
            ...
            self.fail("list() should accept workload_name parameter")

        # This should fail without workload_name (it's now required)
