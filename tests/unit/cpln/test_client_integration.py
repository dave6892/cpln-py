...
from cpln.models.containers import ContainerCollection
...
class TestCPLNClientIntegration(unittest.TestCase):
    ...
    def test_client_has_all_collections(self) -> None:
        ...
        self.assertTrue(hasattr(self.client, "containers"))
    ...
    def test_collection_types(self) -> None:
        ...
        self.assertIsInstance(self.client.containers, ContainerCollection)
    ...
    def test_collection_client_references(self) -> None:
        ...
        self.assertEqual(self.client.containers.client, self.client)

    def test_containers_collection_interface(self) -> None:
        """Test that containers collection has expected interface"""
        containers = self.client.containers

        # Test that it has the expected methods
        self.assertTrue(hasattr(containers, "list"))
        self.assertTrue(callable(containers.list))

        # Test that get and create raise NotImplementedError
        with self.assertRaises(NotImplementedError):
            containers.get(id="test")
    ...
    def test_client_initialization_from_env(self) -> None:
        ...
        with (
            ...
            self.assertIsInstance(client.containers, ContainerCollection)
            self.assertEqual(client.containers.client, client)
